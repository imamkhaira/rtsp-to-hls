...
const result2 = dotenv.config({ path: `./env/${environment}.env` });

if (result2.error) throw result2.error;

/* place config constants below */

export const SERVER_ADDRESS = process.env.SERVER_ADDRESS || 'http://192.168.100.198:3000';
